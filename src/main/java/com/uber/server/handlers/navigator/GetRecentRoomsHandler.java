...
public class GetRecentRoomsHandler implements PacketHandler {
    ...
    public void handle(GameClient client, ClientMessage message) {
        ...
        com.uber.server.event.packet.navigator.MyRoomHistorySearchEvent event = new com.uber.server.event.packet.navigator.MyRoomHistorySearchEvent(client, message);
